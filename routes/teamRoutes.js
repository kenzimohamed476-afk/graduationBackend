...
router.post("/send-invitation",verifyToken,teamController.sendInvitation);
router.get("/invitations",verifyToken,teamController.getInvitations);
router.post("/handle-invitation",verifyToken,teamController.handleInvitation);
